//part 1: find the index of the number 2021
...
//part 2: only 2 numbers will add together to get 2021, find the product of the 2 numbers
for (num1 of input) {
  for (num2 of input) {
    if (num1 + num2 == 2021) {
...
for (let i = 0; i < input.length; i++) {
  for (let j = i + 1; j < input.length; j++) {
    for (let l = j + 3; l < input.length; l++) {
      if (input[i] + input[j] + input[l] === 2021) {
        console.log(input[i] * input[j] * input[l]);
        console.log(input[i], input[j], input[l]);
      }
    }
  }
...
for (let i = 0; i < input.length; i++) {
  for (let j = i + 1; j < input.length; j++) {
    for (let l = j + 1; l < input.length; l++) {
      for (let k = l + 1; k < input.length; k++) {
        if (input[i] + input[j] + input[l] + input[k] === 2021) {
          console.log(input[i] * input[j] * input[l]);
          console.log(input[i], input[j], input[l], input[k]);
        }
      }
    }
  }
